      ...
      <ul className="flex m-10">
        ...
        <li>
          <a
            ...
            className="px-5 py-2.5 rounded-full text-white text-sm tracking-wider font-medium border border-current outline-none bg-purple-500 hover:bg-purple-800 ml-5"
          >
            Categorias
          </a>
        </li>
